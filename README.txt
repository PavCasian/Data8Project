...
**Data**: Personal information, interview performance and behavioural compentency indices (in-course information) of candidates that applied for different courses at a training provider company.

**Task**: Link candidate data from different files so that a candidate can be easily traced from the beginning of the recruitment process to the end of the course. All the data needs to be metamorphosed into normalised tables in a Microsoft SQL Server Database(MSSD).
...
Additional notes:
 - The data comes into 4 folders in S3: Talent, SpartaDays, Interview Notes, Academy
